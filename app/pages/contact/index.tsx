...
export default function Contact() {
    ...
    return (
        <div className="h-screen bg-[#161c33] border-[#fff0d5] border-8 relative flex flex-col overflow-hidden">
            ...
            <div>
                <img src="./keyboard.png" className="h-96 absolute top-0 right-0 z-0 rotate-[30deg]" />
            </div>
            <div className="flex-grow flex ml-20 mt-14">
                ...
                <div className="bg-[#fff0d5] border-[#0d7d6d] border-4 h-[60%] w-[50%] rounded-2xl z-10 mt-10 ml-12">
                    <div className="flex flex-col ml-10">
                        <h2 className="text-2xl font-semibold mt-8">I'm always up for a chat.</h2>
                        ...
                        <div className="mt-6 text-xl">
                            <span>Did you get a chance to check out my <Link href={"https://drive.google.com/file/d/1Jq79wG_Zq-aBTrytyvMPnWwoXI_GCQpV/view?usp=sharing"} className="underline text-[#0d7d6d] decoration-[#0d7d6d] underline-offset-4 font-semibold hover:text-[#109c87] hover:decoration-[#109c87]">resume</Link>
                                ?
                            </span>
                        </div>
                    </div>
